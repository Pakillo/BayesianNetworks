...
The NetBayes R package facilitates modelling bipartite networks (like pollination, frugivory, or herbivory networks) using the Bayesian framework developed by [Young et al. (2021)](https://doi.org/10.1038/s41467-021-24149-x).
...
You can install the development version of NetBayes from [GitHub](https://github.com/) with:
...
The package requires a working installation of [Stan](https://mc-stan.org/). If you don't have `CmdStan` installed, after installing `NetBayes` run:
